...
const DocumentScanScreen = ({ navigation, route }) => {
  ...
  const validateForm = () => {
    ...
    if (!idNumber) {
      ...
      newErrors.idNumber = { message: 'เลขบัตรประชาชนไม่ถูกต้อง (ต้องมี 13 หลัก)' };
    }
    ...
    if (!documents.vehicleWithPlate) {
      newErrors.vehicleWithPlate = { message: 'กรุณาอัปโหลดรูปรถพร้อมป้ายทะเบียน' };
    }
    
    if (!documents.vehicleRegistration) {
      newErrors.vehicleRegistration = { message: 'กรุณาอัปโหลดรูปเล่มทะเบียนรถ' };
    }
  ...
  const handleLicensePlateScan = (data) => {
    ...
    if (data) {
      ...
      Toast.show({
        ...
        text2: `ป้ายทะเบียน: ${data.licensePlate} ${data.province ? 'จังหวัด' + data.province : ''}`,
      });
    }
  };
        ...
        >
          ...
          <Animatable.View animation="fadeInUp" duration={600} delay={200}>
            ...
            <View style={tw`mb-6`}>
              ...
              <View style={tw`bg-gray-50 p-4 rounded-lg border border-gray-200 mb-4`}>
                <Text style={{
                  fontFamily: FONTS.FAMILY.MEDIUM,
                  fontSize: FONTS.SIZE.S,
            ...
            <View style={tw`mb-8`}>
              ...
              <DocumentUploader
                ...
                onPress={handleVehicleRegistrationImage}
