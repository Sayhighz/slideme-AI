// common/uploadRoutes.js
import express from 'express';
import multer from 'multer';
import path from 'path';
import fs from 'fs';
import { fetchImage, uploadBeforeService, uploadAfterService } from '../../controllers/common/uploadController.js';
...
/**
 * @swagger
 * /api/v1/upload/upload_before_service:
 *   post:
...
/**
 * @swagger
 * /api/v1/upload/upload_after_service:
 *   post:
